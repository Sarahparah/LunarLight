...
class LocalData {
    ...
    let stonesInfo = [
        ...
        "Garnet": """
                    The red garnet gives Capricorn the extra energy that he may sometimes feel he lacks as his ambitions extend beyond the power to get there. The garnet is like a stubborn PT: "Yes, one more step! Fight! You can! You have the power!" The garnet also helps Capricorn who may be a little shy to attract his love and live his lusts.
                    
                    Garnet is also the month's stone of January and is of course suitable for Capricorn!
        """,
        
        "Aquamarine": """
                    Properties: Provides courage, protection and helps you to communicate. Aquamarine is a stone for truth and sincerity. Aquarius' sensitive side needs to be able to hold on to what is true in an Universe that is constantly changing and that Aquarius follows.
...
""",
        ...
        "Lapis Lazuli": """
            ...
            Properties:  MYSTERY, MEDITATION, WISDOM, KNOWLEDGE are key words for lapis lazuli. It helps us to find esoteric and mysterious knowledge and that it also strengthens our wisdom so that we can understand this knowledge. It also stands for focus, freedom, being able to think outside the box, protection (especially of the feminine) and is a door opener to other dimensions and inner vision. Lapis lazuli is said to strengthen inner vision, meditation and a deep understanding of man.
...
"""
    ...
    //
    //    "Granate","Aquamarine","Turkos","Coral", "Aventurine", "Tigers eye", "Karneiol", "Lapiz", "Rose Quartz", "Pink turmalin" , "Malachite", "Citrine"]
